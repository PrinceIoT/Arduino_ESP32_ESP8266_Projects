...
void loop() {
  // Read mains and solar voltage
  mainsVoltage = analogRead(mainsVoltagePin) * (5.0 / 1023.0) * 230.0;  // Convert analog reading to voltage (assuming 5V reference and 220V mains)
...
float calculatePhaseError() {
  ...
  float mainsCycleTime = 1000000.0 / 50.0;    // Duration of one mains cycle in microseconds
  float solarCycleTime = 1000000.0 / 49.0;    // Duration of one solar cycle in microseconds
