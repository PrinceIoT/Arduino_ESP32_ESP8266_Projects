...
const char* ssid = "dekut"; /* Add your router's SSID */
const char* password = "dekut@ict2020?"; /*Add the password */
...
void setup() 
{
  ...
  //IPAddress ip(172,16,120,44);   
  //IPAddress gateway(172,16,120,1);   
