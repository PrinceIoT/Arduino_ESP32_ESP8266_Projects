...
void loop() {
 ...
 // mainsVoltage = 230.0;//analogRead(mainsVoltagePin) * (5.0 / 1023.0) * 230.0;  // Convert analog reading to voltage (assuming 5V reference and 220V mains)
  ...
  //if (mainsVoltage > 5.0 && mainsFrequency > 40.0 && mainsFrequency < 60.0)
  if (mainsFrequency > 40.0 && mainsFrequency < 60.0) {
    ...
    //solarFrequency = 40.0;//analogRead(solarFrequencyPin) * (5.0 / 1023.0) * 50.0;  // Convert analog reading to frequency (assuming 5V reference and 60Hz solar signal)
