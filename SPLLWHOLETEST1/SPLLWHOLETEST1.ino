...
int fr; // Adjusts frequency value via fr
...
int period(float frq){
  float pr = 1000000/(frq*200);
  int fin = pr - 78;//27  are the clock cycles we are loosing for Mains
 // int fin = pr - 6;//27  are the clock cycles we are loosing
  return fin;
  }
...
//int periodc(float caes_frequency){
 ...
 // float pr = 1000000/(caes_frequency*200);
  //int fin = pr - 55;//27  are the clock cycles we are loosing for Mains
//  int fin = pr - 6;//27  are the clock cycles we are loosing
//  return fin;
 // }
