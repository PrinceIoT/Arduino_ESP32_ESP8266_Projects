...
void setup()
{
  ...
  // Interrupt on pin 3 to detect zero point threshold
  pinMode(3, INPUT_PULLUP);
  attachInterrupt(digitalPinToInterrupt(3), zeroPointDetect, FALLING);               
