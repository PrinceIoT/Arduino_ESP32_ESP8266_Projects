...
const int zmptSensorPin = A1;  // Replace A1 with the actual pin number
...
const int maxADCValue = 500;  // Replace 500 with the actual maximum ADC value

// Define the actual AC mains voltage scaling factor
const float voltageScalingFactor = 230.0 / maxADCValue;  // Replace 230.0 with the desired mains voltage
